"use strict";
const keys = document.querySelector('.calculator-keys'); //select the element with class 'calculator-keys'
const display = document.querySelector('.calculator-screen'); //to receive inputs from the user to the calculator screen
...
keys.addEventListener('click', (event) => {
    const target = event.target; //to get the clicked target element
